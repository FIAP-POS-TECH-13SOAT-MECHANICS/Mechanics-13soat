...
terraform -chdir="./infra" destroy -target="helm_release.metrics_server" -target="helm_release.ingress_nginx" -target="helm_release.mailpit" -target="helm_release.external_secrets" -auto-approve
