...
namespace Mechanics.Tests.Unit.Mocks
{
    ...
    public class EmailServiceMock : IEmailService
    {
        ...
        public Task SendWorkOrderStatusChanged(Customer customer, WorkOrder workOrder, string previousStatus, string newStatus, CancellationToken cancellationToken = default)
        {
        ...
        public Task SendUserPasswordCreationCode(User user, string passwordCreationCode, CancellationToken cancellationToken = default) =>
            Task.CompletedTask;
